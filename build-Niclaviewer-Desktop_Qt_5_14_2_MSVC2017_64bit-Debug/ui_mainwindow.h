...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(label_img_bot, 2, 1, 1, 1);
        ...
        gridLayout->addWidget(groupBox_2, 3, 3, 5, 4);
        ...
        gridLayout->addWidget(label, 1, 3, 1, 6);
        ...
        label_img_center = new QLabel(centralwidget);
        ...
        gridLayout->addWidget(label_img_center, 1, 1, 1, 1);
        ...
        gridLayout->addWidget(label_img_top, 0, 1, 1, 1);
        ...
        gridLayout->addWidget(label_img_right, 1, 2, 1, 1);

        frame = new QCustomPlotter(centralwidget);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);

        gridLayout->addWidget(frame, 0, 3, 1, 6);
